...
import 'package:flutter_application_1/core/models/friends%20model.dart';
...
//////this is used to add friends//////////////
  Future addFriend(
    ...
    try {
      await firebaseFireStore
          .collection('Friends')
          .doc(friendsModel.receiverId)
          .collection("FriendList")
          .doc(friendsModel.senderId)
          .set(friendsModel.toJson());
  ...
  //////this is used to add friends//////////////
  Future deleteFrindRequest(FriendsModel friends, senderId, receiverId) async {
    try {
      await firebaseFireStore
          .collection('Friends')
          .doc(friends.receiverId)
          .collection("FriendList")
          .doc(friends.senderId)
          .delete();
